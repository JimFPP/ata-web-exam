...
document.getElementById("notes").addEventListener("mousemove",function(evt){
...
$('#heart').on('click',  function(event){
  event.preventDefault();
    ...
    $(event.currentTarget).toggleClass('Fill_heart');
...
$('#like').on('click',  function(event){
  event.preventDefault();
    ...
    $(event.currentTarget).toggleClass('Fill_like');
